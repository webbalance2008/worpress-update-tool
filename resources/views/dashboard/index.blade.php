<x-app-layout>
    ...
    <div class="flex flex-wrap items-center gap-4 mb-8">
        ...
        {{-- Agent Plugin Changelog --}}
        <a href="{{ route('agent-plugin.changelog') }}" class="flex items-center gap-2 px-4 py-2 rounded-lg border border-white/10 bg-white/[0.03] text-white/60 hover:bg-white/[0.06] text-sm font-mono tracking-wide transition-colors">
